...
# User Profile
- 현재 상황: 일시적인 저음역대 난청 및 내이수종 발생 (4월 30일부터 회복 루틴 진행 중)
- 현재 목표: 내이수종 완화 및 자율신경계 활성도 회복 (6월 말까지 회복 기간 유지)
- 향후 계획: 7월부터 본격적인 다이어트 돌입 예정 (현재보다 섭취량 300kcal 감소, 활동량 200kcal 증가 목표)
...
1. 오늘의 식단과 활동량이 현재 '내이수종 완화 및 자율신경계 회복(안정)'에 적절했는지 분석하고, 잘한 점을 찾아 무조건 칭찬을 먼저 듬뿍 해줘.
2. 7월부터 시작할 '본격적인 다이어트 목표(활동량 +200kcal)'를 고려했을 때, 오늘의 활동량이 미래의 다이어트 기준에 비해 얼마나 부족하거나 적절했는지 부드럽게 짚어줘.
3. 무리하지 않는 선에서 자율신경계에 무리를 주지 않고 활동량을 조금 더 채울 수 있는 따뜻한 조언이나 응원을 건네줘.
...
[활동량 평가]
(제공된 활동 현황을 바탕으로 한 활동량 분석, 미래의 다이어트 목표와 비교한 피드백)
